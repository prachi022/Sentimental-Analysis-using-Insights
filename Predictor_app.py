...
def load_model():
    print("Loading model...")
    global pickle_model
    file = open("E:\\study\\forsk\\day-73\\pickle_model.pkl", 'rb')
    pickle_model = pickle.load(file)

    global vocab
    file = open("E:\\study\\forsk\\day-73\\feature.pkl", 'rb')
...
def load_csv():
    ...
    scrappedetsyReviews = pd.read_csv(r"E:\\study\\forsk\\day-73\\reviews_etsy - reviews_etsy.csv", index_col=False, skiprows=[0], names=["SNo", "Review"])
